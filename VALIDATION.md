...
![account_deletion.html](documentation/html-linting/delete-account.png)


## CSS

All of these files were chosen because they all use the main base.css file, as well as a custom ccs file in the static file of their respective app folders. All passed validation without errors.
![checkout.css](documentation/css-linting/checkout.png)
![welcome.css](documentation/css-linting/index.png)
![shop.css](documentation/css-linting/shop.png)


## JavaScript

These are all the js files the project required. All Three again came back from JShint with no reported errors.
